...
<body>
    ...
    <nav class="navBar">
        <div class="bergerMenu-placeholder">
            ...
            $original_path = $_SESSION['profile_image'];
            $new_path = str_replace("../", "./", $original_path);
            ...
            ?>
                <div class="sidebar">
                    ...
                    <div class="profile">
                        <img class="profile-icon" src="<?php echo isset($_SESSION['profile_image']) ? $new_path : './assets/SB_image/userPhoto.jpg'; ?>" alt="User Icon" />
        ...
        <div class="User-placeholder">
            ...
            <div class="photo-placeholder">
                <img class="user-photo" src="<?php echo isset($_SESSION['profile_image']) ? $new_path : './assets/SB_image/userPhoto.jpg'; ?>">
                                    ...
                                    <div class="select-option"> 
                                        ...
                                        <div class="base-container">
                                            ...
                                            <div class="collapse" id="cv-store">   
                                                ...
                                                <div class="options-container">
                                                    <a>
                                                        <img class="option-pic" src="./assets/uploads/FM_Logo.png">
                                                    </a>
                                        ...
                                        <div class="base-container">
                                            ...
                                            <div class="collapse" id="cate">
                                                <div class="options-container">
                                                    <a>
                                                    <img class="option-pic" src="./assets/foodTypeIcon/mainmeal.png">
                                                    </a>
                                                ...
                                                <div class="options-container">
                                                    <a>
                                                    <img class="option-pic" src="./assets/foodTypeIcon/riceball.png">
                                                    </a>
                                                ...
                                                <div class="options-container">
                                                    <a>
                                                    <img class="option-pic" src="./assets/foodTypeIcon/sandwich.png">
                                                    </a>
                                                ...
                                                <div class="options-container">
                                                    <a>
                                                    <img class="option-pic" src="./assets/foodTypeIcon/veg.png">
                                                    </a>
                                                ...
                                                <div class="options-container">
                                                    <a>
                                                        <img class="option-pic" src="./assets/foodTypeIcon/bread.png">
                                                    </a>
                                                ...
                                                <div class="options-container">
                                                    <a>
                                                        <img class="option-pic" src="./assets/foodTypeIcon/dessert.png">
                                                    </a>
